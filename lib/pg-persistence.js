...
class Persistence {
  async addSong(title, url, videoId) {
    const statement = `INSERT INTO songs (title, url, video_id) VALUES ( $1, $2, $3);`;
    const result = await client.query(statement, [title, url, videoId]);
