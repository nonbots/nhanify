...
class Persistence {
   ...
   */
  async createPlaylist(title, username, visiability, creatorId) {
    ...
    const ADDUSERTOPLAYLIST = `INSERT INTO "playlists-users" (playlist_id, user_id) VALUES ($1, $2), ($1, $3)`;
    const values3 = [playlistId, sharedUserId, creatorId];
